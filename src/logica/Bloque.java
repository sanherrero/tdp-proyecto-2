...
public class Bloque {
	...
	public Bloque(boolean ocupado, int x, int y, String img) { //Si al momento de crearse ya esta ocupado es porque es una pared, en caso contrario es un bloque transitable
		posX = x;
		posY = y;
		this.ocupado = ocupado;
